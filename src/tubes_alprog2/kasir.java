...
public class kasir extends javax.swing.JFrame implements crud{
    ...
    public void insert(){
        ...
        total.add(Integer.parseInt(subtotalx.getText()));
    ...
    public void total(){
        ...
        String total_b = df.format(total_beli);
        totalx.setText(total_b);
    }
    ...
    private void initComponents() {
        ...
        theme1 = new GlossyPanel.Theme();
        colorStyles1 = new GlossyJButton.ColorStyles();
    ...
    private GlossyJButton.ColorStyles colorStyles1;
    ...
    private GlossyPanel.Theme theme1;
